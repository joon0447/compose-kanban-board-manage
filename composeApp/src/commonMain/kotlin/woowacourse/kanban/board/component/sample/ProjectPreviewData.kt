...
class TaskCardPreviewData: PreviewParameterProvider<TaskCardData> {
    override val values: Sequence<TaskCardData> = sequenceOf(
        ...
        TaskCardData(
            ...
            tags = Tags(listOf(Tag("학습"), Tag("API"))),
        ...
        TaskCardData(
            ...
            tags = Tags(listOf(Tag("리팩토링"), Tag("상태관리"))),
            profile = Profile("다이노", Res.drawable.profile),
        ...
        TaskCardData(
            ...
            tags = Tags(listOf(Tag("최적화"), Tag("성능"))),
            profile = Profile("다이노", Res.drawable.profile),
            status = Status.DONE,
        ),
        TaskCardData(
            ...
            tags = Tags(listOf(Tag("API"), Tag("비동기"))),
            profile = Profile("페임스", Res.drawable.profile),
            status = Status.DONE,
        ),
        TaskCardData(
            ...
            tags = Tags(listOf(Tag("기능"), Tag("UX"))),
            profile = Profile("다이노", Res.drawable.profile),
            status = Status.DONE,
        ),
    )
